...
function Loading(props) {
    return (
        <IonGrid style={{height:'100%', width:'100%', background: '#222428', position: 'absolute', zIndex:'2000'}}>
            <IonRow style={{ marginTop: '35vh', width: '100%' }}>
                <IonCol md={{ span: 8, offset: 2 }} style={{ textAlign: 'center' }}>
                    <ReactLoading className="preloader" type='bars' color='#0db0bf' height={200} width={200} />
                </IonCol>
            </IonRow>
        </IonGrid>
    )
