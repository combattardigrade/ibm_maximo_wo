        ...
        return (
            <Fragment>
                <IonItem  lines="full" detail button onClick={e => { e.preventDefault();  this.handleToggleLongDescModal(true)} }>
                    <IonGrid>
                        <IonRow>
                            <IonCol  style={{color:'#005cff', fontWeight:'bold'}}>Orden de Trabajo</IonCol>
                        </IonRow>
                        <IonRow>
                            <IonCol size="4">
                        ...
                        <IonRow>
                            <IonCol size="4"><IonLabel className="dataSubtitle">Descripción: </IonLabel></IonCol>
                            <IonCol size="8"><IonLabel className="dataField">{'description' in currentWorkOrder ? currentWorkOrder.description : '-'}</IonLabel></IonCol>
                        </IonRow>
                        <IonRow>
                            <IonCol size="4"><IonLabel className="dataSubtitle">Fecha de inicio: </IonLabel></IonCol>
                            <IonCol size="8"><IonLabel className="dataField">{'targstartdate' in currentWorkOrder ? currentWorkOrder.targstartdate : '-'}</IonLabel></IonCol>
                        </IonRow>
                        <IonRow>
                            <IonCol size="4"><IonLabel className="dataSubtitle">Activo: </IonLabel></IonCol>
                            <IonCol size="8"><IonLabel className="dataField">{'assetDescription' in currentWorkOrder ? currentWorkOrder.assetDescription : '-'}</IonLabel></IonCol>
                        </IonRow>
                    </IonGrid>
                </IonItem>
